...
def extract_text(file):
    ...
    if file.type == "application/pdf":
                ...
                for page in pdf.pages:
                    ...
                    if page_text and page_text.strip():
                        ...
                        try:
                            ...
                            # 2. Try Pytesseract if RapidOCR was not enough/available
                            ...
                            extraction_error = f"OCR Rendering error: {str(e)}. (Hint: Check poppler-utils)"
                            ocr_missing = True
        ...
        try:
            ...
            st.error(f"Failed to open DOCX: {str(e)}")
    ...
    if ocr_missing:
        st.warning("⚠️ OCR processing encountered an error or no text matched. (Scanned PDFs require poppler-utils)")
        if extraction_error:
            st.info(f"Technical Detail: {extraction_error}")
